...
if(msg != null){
out.println("<script>alert('Result sent to data owner')</script>");
}
%>
...
<td><%=rs.getString("fid")%></td>
	...
	<td><a href="auditchallenge1.jsp?fileid=<%=rs.getString("fid")%>&filename=<%=rs.getString("fname")%>&groupname=<%=rs.getString("groupname")%>"><b>Audit</b></a></td>
</tr>
<%
}
%>
